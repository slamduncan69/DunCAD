...
"\n"
"BUG FIX: STALE LINE RANGE TRAP (shape_menu.c):\n"
"  After wrap_selected() adds lines (e.g. difference block = 4 lines),\n"
"  sel_line_end still pointed to original line 1. A subsequent\n"
"  translate would only wrap line 1, not the full statement.\n"
"  Fix: After every wrap_selected(), count newlines in the new buffer\n"
"  and update ctx->sel_line_end. Moved line counting out of the\n"
"  transform-panel-only block into the general wrap path.\n"
"\n"
...
"\n"
"FOR THE NEXT AGENT:\n"
"  - The stale line range fix is committed but needs interactive\n"
"    verification (test: add cube, right-click difference with\n"
"    cylinder, then right-click translate — all 4 lines should wrap)\n"
"  - SCAD ordering rules are in talmud at:\n"
"    talmud reference architecture scad ordering\n"
